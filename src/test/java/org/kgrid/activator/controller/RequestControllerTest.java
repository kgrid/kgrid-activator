...
public class RequestControllerTest {
    ...
    public void setup() {
        ...
        Mockito.lenient().when(endpointHelper.getEndpoint(ENDPOINT_URI)).thenReturn(endpoint);
    ...
    public void testExecuteResourceEndpoint_InvalidAcceptType() {
        ...
        ResponseEntity<Object> response = requestController.executeResourceEndpoint(NAAN, NAME, API_VERSION, ENDPOINT_NAME, headers, servletRequest);
        assertAll(
                () -> verify(endpointHelper).createEndpointId(NAAN, NAME, API_VERSION, ENDPOINT_NAME),
