...
public class IoSpecGenerator {
	...
	public ioSpec covertInputOutputMessageToCodeMetadata(KnowledgeObject ko) {
		...
		StmtIterator iterInput = modelInput.getResource(kgridNamespace + "inputMessage").listProperties();
		...
		for (String param : params) {
			StmtIterator paramDesc = modelInput.getResource(kgridNamespace +param+"/").listProperties();
		...
		StmtIterator iterOutput = modelOutput.getResource(kgridNamespace + "outputMessage").listProperties();
